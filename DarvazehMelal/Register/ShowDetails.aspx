<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowDetails.aspx.cs" Inherits="Register_ShowDetails" MasterPageFile="~/Site.master" %>
...
--%>        <PagerStyle BackColor="#FEF5CC" ForeColor="#333333" HorizontalAlign="Center" />
        ...
        <RowStyle BorderColor="#F2E9C4" BorderStyle="Solid" BorderWidth="1px"/>
                            ...
                            <div runat="server" id="facilitiesDiv" style=" background-color:#FFD829; margin:10px; padding:3px; border:1px solid #C49527; border-radius:5px; font-size:13px; font-weight:bold">
                            ...
                            runat="server" Text='<%# Bind("Facilities") %>'></asp:Label>
                                ...
                                <div runat="server" id="commentsDiv" style=" background-color:#EFDC9C; margin:10px; padding:3px; border:1px solid #C49527; border-radius:5px; font-size:13px; font-weight:bold">
                ...
                <div id="Div1" style="margin: 0 auto; margin-top:20px; width: 100% " runat="server">
                    <table style="width: 100%; margin: 0 auto">
                <tr>
                    <td>
                        &nbsp;
                        <asp:ImageButton ID="Image1" runat="server" Width="100px" Height="100px"  OnCommand="Image_Command" CommandArgument='<%# Image1.ID %>'/>
                    </td>
                    <td>
                        &nbsp;
                        <asp:ImageButton ID="Image2" runat="server" Width="100px" Height="100px" OnCommand="Image_Command" CommandArgument='<%# Image2.ID %>'/>
                    </td>
                    <td>
                        &nbsp;
                        <asp:ImageButton ID="Image3" runat="server" Width="100px" Height="100px" OnCommand="Image_Command" CommandArgument='<%# Image3.ID %>'/>
                    </td>
                    <td>
                        &nbsp;
                        <asp:ImageButton ID="Image4" runat="server" Width="100px" Height="100px" OnCommand="Image_Command" CommandArgument='<%# Image4.ID %>'/>
                    </td>
                    <td>
                        &nbsp;
                        <asp:ImageButton ID="Image5" runat="server" Width="100px" Height="100px" OnCommand="Image_Command" CommandArgument='<%# Image5.ID %>'/>
                    </td>
                </tr>
                <tr>
                    <td>
                        &nbsp;
                        <asp:ImageButton ID="Image6" runat="server" Width="100px" Height="100px" OnCommand="Image_Command" CommandArgument='<%# Image6.ID %>'/>
                    </td>
                    <td>
                        &nbsp;
                        <asp:ImageButton ID="Image7" runat="server" Width="100px" Height="100px" OnCommand="Image_Command" CommandArgument='<%# Image7.ID %>'/>
                    </td>
                    <td>
                        &nbsp;
                        <asp:ImageButton ID="Image8" runat="server" Width="100px" Height="100px" OnCommand="Image_Command" CommandArgument='<%# Image8.ID %>'/>
                    </td>
                    <td>
                        &nbsp;
                        <asp:ImageButton ID="Image9" runat="server" Width="100px" Height="100px" OnCommand="Image_Command" CommandArgument='<%# Image9.ID %>'/>
                    </td>
                </tr>
            </table>
                </div>

        <div style=" padding-left:10px; padding-right:10px" runat="server" id="googleMapdiv">
        <cc1:GoogleMap ID="GoogleMap1" runat="server" Address="Iran" Zoom="8" MapType="Roadmap" Width="100%" Height="300px" EnableScrollWheelZoom="true" style="float:left"></cc1:GoogleMap>
        <cc1:GoogleMarkers ID="GoogleMarkers1" runat="server" TargetControlID="GoogleMap1" >
        <Markers>
        <cc1:Marker ></cc1:Marker>
        </Markers>
