<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdManagement.aspx.cs" Inherits="Administration_AdManagement" MasterPageFile="~/Site.master"%>

<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" Runat="Server">
<fieldset>
<legend>فهرست تبلیغات</legend>
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateDeleteButton="true"  AutoGenerateColumns="False" AllowPaging="True"  GridLines="None" ShowHeader="false" OnRowDeleting="GridView1_OnRowDeleting" DataKeyNames="id, url, target, alt, imageURL, comments" OnDataBinding="GridView1_OnDataBinding">
        ...
        <tr>
        <td>
            <asp:Label ID="Label7" runat="server" Text="پیوند تبلیغ : "></asp:Label> <asp:Label ID="Label8" runat="server" Text='<%# Bind("url") %>'></asp:Label>
        </td>
        </tr>
        </table>
        <table>
...
<br /><br />
<fieldset>
<legend>درج تبلیغ جدید</legend>
نکته اینکه تصویر مورد نظر حتما باید با عرض 780 و با ارتفاع 100 در واحد پیکسل باشد ، لطفا پیش از بالاگذاری تصویر مورد نظر اندازه آن را بررسی نمائید . | برای پیوند تبلیغ میتوانید از یک پیوند داخلی وبسایت و یا یک پیوند خارجی از وبسایتی دیگر انتخاب نمائید ، درصورتیکه از صفحات داخلی سایت برای صفحه مربوط به توضیحات تبلیغ استفاده می کنید پیش از درج تصویر باید صفحه و پیوند آنرا آماده کنید .
